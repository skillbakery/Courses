...
declare namespace Multimodal {
  ...
  type Image = Data & {
    /** Type of the content block */readonly type: "image";
  };
  /** Content block for video data */
  type Video = Data & {
    /** Type of the content block */readonly type: "video";
  };
  /** Content block for audio data */
  type Audio = Data & {
    /** Type of the content block */readonly type: "audio";
  };
  /** Content block for plain text data */
  type PlainText = Data & {
    /** Type of the content block */readonly type: "text-plain";
    /**
